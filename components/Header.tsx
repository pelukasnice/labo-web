      ...
      >
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center">
            <div
              className={`transition-all duration-300 ${
                isScrolled ? "w-[100px] h-[35px]" : "w-[150px] h-[100px]"
              }`}
            >
              <Image
          ...
          <div className={`hidden md:flex items-center transition-all duration-300 ${
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`hover:text-primary transition-colors duration-200 ${
                  isScrolled ? "text-gray-700 text-sm font-medium" : "text-gray-800 font-medium"
                }`}
              >
                {link.label}
              </Link>
            ...
            <Link
              href="/turnos"
              className={`bg-primary text-white rounded-full font-semibold hover:bg-primary-dark transition-all duration-200 shadow-medical hover:shadow-lg ${
