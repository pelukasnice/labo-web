      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-br from-primary-light/10 to-white rounded-3xl p-8 md:p-12 shadow-soft mb-20"
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Preparación previa y recomendaciones
            </h2>
          ...
          {/* CTA para sacar turno */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="text-center bg-gradient-to-br from-primary to-primary-dark rounded-3xl p-8 md:p-12 text-white"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              ¿Lista para tu estudio?
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Agenda tu turno y cuida tu salud ginecológica
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/turnos"
                className="bg-white text-primary px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl text-center"
              >
                Sacar turno
              </Link>
              <Link
                href="/"
                className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white/10 transition-all duration-200 text-center"
              >
                Volver al inicio
              </Link>
            </div>
